...
class Role {
    ...
    public function __construct() {
        ...
        $this->CI->student_login_prefix = "user";
    ...
    public function get_random_password($chars_min = 6, $chars_max = 8, $use_upper_case = false, $include_numbers = false, $include_special_chars = false) {
        ...
        $selection = 'aeuoyifsladsljshgkjsghsdkjhdreeoeywtowedzmncxlvkjlkdvvcxvmbcdfghjklmnpqrstvwxzopgfpgfgigjeremkasdmkcvkvvjkbvbmvkbmdfdfgjipoiewgndkvdm';
        if ($include_numbers) {
